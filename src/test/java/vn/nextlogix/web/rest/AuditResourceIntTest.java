...
import vn.nextlogix.NextlogixApp;
import vn.nextlogix.config.audit.AuditEventConverter;
import vn.nextlogix.domain.PersistentAuditEvent;
import vn.nextlogix.repository.PersistenceAuditEventRepository;
import vn.nextlogix.service.AuditEventService;
...
@SpringBootTest(classes = NextlogixApp.class)
@Transactional
